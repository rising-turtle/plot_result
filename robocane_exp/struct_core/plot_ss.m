...
tr1 = dlmread('./robocane_ss/gt_comp/gt_cp/indoor1_gt_cp.csv'); 
tr2 = dlmread('./robocane_ss/vins-mono/lab_1_tum_cp.csv'); 
tr3 = dlmread('./robocane_ss/vins-rgbd/vins_rgbd_lab1_tum_cp.csv'); 
tr4 = dlmread('./robocane_ss/dvio_3/lab_1_tum_cp.csv'); 
